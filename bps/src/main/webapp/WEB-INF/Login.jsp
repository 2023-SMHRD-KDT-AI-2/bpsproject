							...
							<div class="col-lg-6">
								<div class="p-5">
									...
									<form class="user" action="" method="post">
									 ...
									 <a class="btn btn-google btn-user btn-block" id="naverIdLogin_loginButton" href="javascript:void(0)">
             						 <span>네이버 로그인</span>
          							</a>
          							
										<a href="" class="btn btn-google btn-user btn-block">
											
											<!--구글 로그인--> <i class="fab fa-google fa-fw" ></i> 구글 간편 로그인
										</a>
										...
										<a id="custom-login-btn" href="javascript:loginWithKakao()"
											class="btn btn-kakao btn-user btn-block"> <!--카카오 로그인-->
