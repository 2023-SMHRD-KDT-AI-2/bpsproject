...
<body>
	<div class="container-xxl position-relative bg-white d-flex p-0">
		...
		//String id = (String) request.getAttribute("ids"); //페이지에 유저 정보 불러오기 전까지 임시 주석처리
		String id = "test"; //임시로 지정한 아이디. 유저 정보를 불러와서 페이지에 적용할 시 이 부분 삭제
		%>
		<!--작은창-->
