...
<head>
    ...
    <link rel="stylesheet" href="css/차량관리.css">
</head>
...
<body>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-2">등록자 정보</h6>
                            <div class="hr-flex">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="schedule-department" placeholder="개발팀">
                                    <label for="schedule-department">부서</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="schedule-name" placeholder="홍길동">
                                    <label for="schedule-name">이름</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="schedule-empid" placeholder="12345">
                                    <label for="schedule-empid">사번</label>
                                </div>
                            </div>
                            <hr>
                            <div>
                                <h6 class="mb-2">타이틀 내용</h6>
                                <div class="form-floating">
                                    <textarea class="form-control" placeholder="Leave a comment here" id="schedule-title" style="height: 70px;"></textarea>
                                    <label for="schedule-title">title</label>
                                </div>
                            </div>
                            <hr>
                            <div>
                                <h6 class="mb-2">세부 내용</h6>
                                <div class="form-floating">
                                    <textarea class="form-control" placeholder="Leave a comment here" id="schedule-detail" style="height: 150px;"></textarea>
                                    <label for="schedule-detail">Comments</label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="CheckCancelButton">
                        <input id="schedule-submit" type="button" value="확인" class="btn btn-success rounded-pill m-2">
                    </div>
    ...
    <script src="js/schedule_submit.js"></script>
